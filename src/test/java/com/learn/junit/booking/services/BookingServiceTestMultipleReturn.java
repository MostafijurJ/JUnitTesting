...
public class BookingServiceTestMultipleReturn {
	...
	void should_CountAvailablePlaces() {
		...
		//given
		when(roomServiceMock.getAvailableRooms()).thenReturn(Collections.singletonList(new Room("Room 1", 4)))
		...
		assertAll(
				...
				() -> assertEquals(expected2, bookingService.getAvailablePlaceCount())
		);
	}
